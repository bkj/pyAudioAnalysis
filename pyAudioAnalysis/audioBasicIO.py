import sys, os, glob, eyed3, ntpath, shutil, numpy
    ...
    try:
        ...
        if extension.lower() == '.aif' or extension.lower() == '.aiff':
            ...
            try:
                ...
                print >> sys.stderr, "Error: file not found or other I/O error. (DECODING FAILED)"
                return (-1,-1)
            ...
            print >> sys.stderr, "Error in readAudioFile(): Unknown file type!"
            return (-1,-1)
    except IOError: 
        print >> sys.stderr, "Error: file not found or other I/O error."
        return (-1,-1)
